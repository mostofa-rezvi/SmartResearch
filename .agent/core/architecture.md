...
2. **Business Logic**:
   ...
   - **Redis Streams + Pub/Sub**: Asynchronous backbone for cross-domain events (e.g., scoring reputation after an answer is accepted). Replaced Kafka to simplify infrastructure.
3. **Data Ecosystem**:
