    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-3xl max-h-[88vh] glass-neu-card flex flex-col overflow-hidden"
        >
          {/* Header */}
          <div className="p-6 md:p-8 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-3">
              <div className="p-3 neu-icon text-primary dark:text-white">
                <Sparkles size={22} />
              </div>
              <div>
                        ...
                        <div className="grid gap-3 sm:grid-cols-2">
                          {result.themes.map((t, i) => (
                            ...
                            >
                              ...
                              {t.papers?.length > 0 && (
                                <p className="text-[10px] font-bold text-primary/70 dark:text-white/70 uppercase tracking-wide">
